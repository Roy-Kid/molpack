...
class Target:
    ...
    def with_restraint(self, restraint: AnyRestraint) -> Self: ...
    def with_atom_restraint(
        self, indices: Sequence[int], restraint: AnyRestraint
    ) -> Self: ...
...
class Molpack:
    ...
    def with_handler(self, handler: _HandlerLike) -> Self: ...
    def with_global_restraint(self, restraint: AnyRestraint) -> Self: ...
